...
//!     codegen-emitted capture descriptor (passed in from the closure's offset-40 slot, ADR-056)
...
// CLOSURE at offset 40 (ADR-056); the async caller passes it in explicitly.
