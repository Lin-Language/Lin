...
describe("GroupStationDepartAfterQuery", () => {
  ...
  it("plans to multiple destinations", () => {
    const trips = [
      ...
      t(st("A", null, 1200), st("B", 1230, 1235), st("D", 1300, null))
    ];
  ...
  it("plans from multiple origins", () => {
    const trips = [
      t(st("A", null, 1000), st("B", 1030, 1035), st("C", 1100, null)),
      t(st("A", null, 1200), st("_", 1230, 1235), st("D", 1300, null))
    ];
