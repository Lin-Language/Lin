...
describe("Service", () => {
  it("checks the start date", () => {
    const service = new Service(20181001, 20181015, allDays, {});
  ...
  it("checks the day of the week", () => {
    ...
    const service = new Service(20181001, 20991231, days, {});
    const result = service.runsOn(20181016, 1);
  ...
  it("checks include days", () => {
    const service = new Service(20991231, 20991231, allDays, { 20181022: true });
  ...
  it("checks exclude days", () => {
    const service = new Service(20181001, 20991231, allDays, { 20181022: false });
