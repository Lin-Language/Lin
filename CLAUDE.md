...
Stdlib lives in `stdlib/*.lin` and is loaded via `include_str!` in `lin-compile`. Current stdlib modules: `std/io`, `std/string`, `std/number`, `std/iter`, `std/array`, `std/object`, `std/async`, `std/fs`, `std/stream`, `std/compress`, `std/http`, `std/net`, `std/process`, `std/tty`, `std/signal`, `std/template`, `std/test`, `std/time`.
